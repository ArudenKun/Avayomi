...
internal static partial class MpvNativeApi
{
    ...
    [LibraryImport(
        MpvNativeLibrary.ImportName,
        EntryPoint = "mpv_create_weak_client",
        StringMarshalling = StringMarshalling.Utf8
    )]
    ...
    internal static unsafe partial int SetProperty(
        MpvHandle* handle,
        string name,
        MpvFormat format,
        void* data
    ...
    internal static unsafe partial int SetPropertyString(
        MpvHandle* handle,
        string name,
        string? data
    );
    ...
    internal static unsafe partial int GetProperty(
        MpvHandle* handle,
        string name,
        MpvFormat format,
        void* data
    ...
    internal static unsafe partial int ObserveProperty(
        MpvHandle* handle,
        ulong replyUserData,
        string name,
        MpvFormat format
    ...
    internal static unsafe partial int CommandAsync(
        MpvHandle* handle,
        ulong replyUserData,
        byte** args
    );
    ...
    internal static unsafe partial void SetWakeupCallback(
        MpvHandle* handle,
