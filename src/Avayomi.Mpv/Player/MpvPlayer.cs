...
public unsafe class MpvPlayer : IDisposable
{
    private readonly Lock _gate = new();
    private readonly MpvPlayerOptions _options;
    ...
    public MpvPlayer(Action<MpvPlayer> beforeInitialize)
        : this(new MpvPlayerOptions { BeforeInitialize = beforeInitialize }) { }

    public MpvPlayer(MpvPlayerOptions options)
    {
        _options = options ?? new MpvPlayerOptions();
    ...
    public MpvPlayerOptions Options => _options;
    ...
    private static unsafe MpvHandle* CreateHandle(MpvPlayerOptions options)
    {
