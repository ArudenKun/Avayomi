...
//
//     public static readonly StyledProperty<MpvPlayer?> PlayerProperty = AvaloniaProperty.Register<
//         VideoView,
//         MpvPlayer?
//     >(nameof(Player));
//
...
//         AvaloniaProperty.Register<VideoView, bool>(nameof(UseCustomHeartbeat), false);
//
...
//     }
//
//     public static readonly DirectProperty<VideoView, double> ExpandedViewportWidthProperty =
//         AvaloniaProperty.RegisterDirect<VideoView, double>(
...
//         AvaloniaProperty.Register<VideoView, double>(nameof(ReferenceViewportWidth));
//
...
//         AvaloniaProperty.Register<VideoView, double>(nameof(ReferenceViewportHeight));
//
...
//         TimeSpan.FromTicks(
//             (long)(TimeSpan.TicksPerSecond / GetEffectiveHeartbeatFps(heartbeatFps))
//         );
//
