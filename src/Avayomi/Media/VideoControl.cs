...
using Avayomi.Controls;

namespace Avayomi.Media;

public class VideoControl : OpenGlControlBase
{
    ...
    public static readonly StyledProperty<MediaPlayer?> PlayerProperty = AvaloniaProperty.Register<
        VideoControl,
        MediaPlayer?
    >(nameof(Player));
    ...
    public static readonly StyledProperty<bool> IsRenderingPausedProperty =
        AvaloniaProperty.Register<VideoControl, bool>(nameof(IsRenderingPaused));
    ...
    public static readonly StyledProperty<bool> UseCustomHeartbeatProperty =
        AvaloniaProperty.Register<VideoControl, bool>(nameof(UseCustomHeartbeat), false);
    ...
    public static readonly StyledProperty<double> AudioSyncOffsetProperty =
        AvaloniaProperty.Register<VideoControl, double>(nameof(AudioSyncOffset));
    ...
    public static readonly DirectProperty<VideoControl, double> ExpandedViewportWidthProperty =
        AvaloniaProperty.RegisterDirect<VideoControl, double>(
    ...
    public static readonly StyledProperty<double> ReferenceViewportWidthProperty =
        AvaloniaProperty.Register<VideoControl, double>(nameof(ReferenceViewportWidth));
    ...
    public static readonly StyledProperty<double> ReferenceViewportHeightProperty =
        AvaloniaProperty.Register<VideoControl, double>(nameof(ReferenceViewportHeight));
    ...
    {
        if (Player == null || _glInterface == null)
            return;
