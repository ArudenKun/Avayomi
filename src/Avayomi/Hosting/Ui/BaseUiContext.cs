...
/// </summary>
/// <remarks>
/// Extend this class to add data, specific to the UI framework (e.g. Avalonia).
/// </remarks>
public abstract class BaseUiContext(bool isLifetimeLinked = true)
{
    /// <summary>
    ...
    /// </value>
    public bool IsLifetimeLinked { get; init; } = isLifetimeLinked;
