...
public class FloatingActionButton : Grid
{
    public static readonly StyledProperty<FabLayout> LayoutProperty = AvaloniaProperty.Register<
    ...
    public static readonly StyledProperty<object?> TriggerContentProperty =
        AvaloniaProperty.Register<FloatingActionButton, object?>(nameof(TriggerContent), "+");

    public static readonly StyledProperty<bool> AutoCloseProperty = AvaloniaProperty.Register<
        FloatingActionButton,
        bool
    >(nameof(AutoClose), true);

    public static readonly StyledProperty<string?> TriggerIconDataProperty =
        AvaloniaProperty.Register<FloatingActionButton, string?>(nameof(TriggerIconData));

    public static readonly StyledProperty<double> TriggerIconSizeProperty =
        AvaloniaProperty.Register<FloatingActionButton, double>(
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        {
            if (child is Button btn && btn != _triggerButton)
            {
    ...
    private void OnChildrenChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        if (e.OldItems != null)
        {
            ...
            {
                if (item is Button btn && btn != _triggerButton)
                {
                    btn.Click -= OnActionButtonClick;
                }
            }
