...
public class SemaphoreSlimDynamic : SemaphoreSlim
{
        ...
        : base(initialCount, maxCount)
    {
        ...
        if (initialCount < 1 || initialCount > maxCount)
    ...
    /// <summary>
    ///     Tries to release a semaphore. This may fail in some rare cases if ChangeCapacity was called several time, in which
    ///     case, it will return false and decrease CurrentSize.
    /// </summary>
