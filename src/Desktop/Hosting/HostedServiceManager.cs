...
public sealed class HostedServiceManager : IHostedServiceManager
{
    ...
    public HostedServiceManager(ILogger<HostedServiceManager> logger, IEnumerable<IHostedService> hostedServices)
    {
        _logger = logger;
    ...
    public void Register<T>(Func<T> serviceFactory, string friendlyName) where T : class, IHostedService
    {
    ...
    private void Dispose(bool disposing)
    {
        ...
        if (disposing)
        {
            ...
            {
                if (service.Service is not IDisposable disposable) continue;
                disposable.Dispose();
