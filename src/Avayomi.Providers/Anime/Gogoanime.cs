        ...
        INewSeasonProvider
{
    ...
    )
    {
        ...
        var response = await HttpClient.ExecuteAsync($"{BaseUrl}?page={page}", cancellationToken);
    ...
    )
    {
        ...
        {
            var epsResponse = await HttpClient.ExecuteAsync(url, cancellationToken);

            var epsDocument = HtmlHelper.Parse(epsResponse);
        ...
        var response = await HttpClient.ExecuteAsync(url, cancellationToken);
    ...
    )
    {
        ...
        //response = await HttpClient.ExecuteAsync(CdnUrl + animeId, cancellationToken);
        response = await HttpClient.ExecuteAsync(url, cancellationToken);

        document = HtmlHelper.Parse(response);
    ...
    )
    {
        ...
        var response = await HttpClient.ExecuteAsync(episodeUrl, cancellationToken);
        ...
        if (response.Contains(">404</h1>"))
            response = await HttpClient.ExecuteAsync(episodeUrl + "-1", cancellationToken);
    ...
    public async ValueTask<List<Genre>> GetGenresAsync(CancellationToken cancellationToken)
    {
        ...
        var response = await HttpClient.ExecuteAsync(BaseUrl, cancellationToken);
