...
public class Media
{
    [GqlSelection("duration")]
    private readonly int? _duration;

    [GqlSelection("updatedAt")]
    private readonly int _updatedAt;
    ...
    /// </summary>
    [GqlSelection("title")]
    public MediaTitle Title { get; private set; } = new();
    ...
    public Date EndDate { get; private set; } = new();
    ...
    public MediaCover Cover { get; private set; } = new();
