...
public class SearchMediaFilter
{
    ...
    public IDictionary<MediaFormat, bool> Format { get; set; } =
        new Dictionary<MediaFormat, bool>();
    public IDictionary<MediaStatus, bool> Status { get; set; } =
        new Dictionary<MediaStatus, bool>();
