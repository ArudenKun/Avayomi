...
{
    public static HttpClient CreateProviderHttpClient(this IHttpClientFactory httpClientFactory) =>
        httpClientFactory.CreateClient(HttpHelper.ProviderHttpClientName);
    ...
    {
        http.DefaultRequestHeaders.Add("User-Agent", HttpHelper.ChromeUserAgent());
